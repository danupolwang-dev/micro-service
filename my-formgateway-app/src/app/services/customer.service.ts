...
export class CustomerService {
  ...
  getRecentCustomers(): Observable<Customer[]> {
    return this.http.get<Customer[]>(`${this.apiUrl}/recent`);
  }
  ...
  suspendCustomer(id: number): Observable<Customer> {
    return this.http.put<Customer>(`${this.apiUrl}/${id}/suspend`, {});
  }

  activateCustomer(id: number): Observable<Customer> {
    return this.http.put<Customer>(`${this.apiUrl}/${id}/activate`, {});
  }
}
